...
コンテントを生成するマークアップ言語のこと。
マークダウンとも呼ばれ、HTML、AsciiDoc、Org、Pandoc、reStructuredText も表す。
詳細は [こちら](/content-management/formats/) を参照のこと。

###### コンテントタイプ (content type) {#content-type}
